...
public class WorldEventRegistry {
    public static WorldEventType WORM_BREACH = registerEventType(new WorldEventType(ResourceLocation.fromNamespaceAndPath(SandwormMod.MODID, "worm_breach"), WormBreachWorldEvent::new, true));
    ...
    public static WorldEventType SPICE_BLOW = registerEventType(new WorldEventType(ResourceLocation.fromNamespaceAndPath(SandwormMod.MODID, "spice_blow"), SpiceBlowWorldEvent::new, true));
}
